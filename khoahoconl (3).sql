...
-- Để có thêm các chỉ mục hoặc ràng buộc nếu cần thiết, bạn có thể thêm chúng ở đây

-- Ví dụ: 
-- ALTER TABLE `exam_schedule`
--   ADD CONSTRAINT `fk_exam_product` FOREIGN KEY (`id_exam`) REFERENCES `product_kh` (`id_product`);
